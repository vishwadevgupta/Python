...
li = ['amazon',2,'facebook', 4.5, True] #Lists are the data type where we can store the multiple
...
print(li[0:4:2]) # here it will print the lists from first to 3rd index while print every 2nd 
                 # list value
...
print(vi, li) # now here what will happen that both lists become equal and whatever will
