...
my_tuple = ("apple", "banana", "cherry") #so tuples are like lists but they are immutable 
...
print(my_tuple.count("apple")) #this will count how many times "apple" appears in the tuple
