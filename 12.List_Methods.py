...
print(
    Basket.index(2, 0, 4)
)  # here we are checking the indev value of 2 between the index 0 to 4
print(
    "c" in Basket2
)  # here we will check if the char d is present in the list or not, it will
# return bool
print(
    Basket2.count("a")
)  # this method will count that how many times do a value occur in list
