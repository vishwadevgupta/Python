...
print(my_set) #here it will print {1, 2, 3, 4, 5, 6} because sets do not allow duplicates.

print(my_set[1]) #this will give an error because sets are unordered and do not support indexing.
...
print(set(list)) #here it will print {1, 2, 3, 4, 5, 6} because sets do not allow duplicates.
