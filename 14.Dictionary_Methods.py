...
)  # Here it will check whether the key "Name" is present in the dictionary or not.
# It will return True if the key is present, otherwise it will return False.

print(
    "John" in Dictionary.values()
)  # Here it will check whether the value "John" is present in the dictionary or not.

print(
    "City" in Dictionary.items()
)  # Here it will check whether the item "City" is present in the dictionary or not.
...
print(
    Dictionary.popitem()
)  # . popitem() - Removes the last inserted item (in versions before 3.7, it removes an arbitrary item)
