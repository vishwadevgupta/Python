...
print (string[0:4]) #if we want to print the character palced between 0 place to 4th place 
print (string[0:4:2]) # if we want to print the string from 0th place to 4th place and need to 
                     # stepup om every second character
print (string[-1]) # now the string will start from the end , like if we print string[-2] it 
                   # will print the second last word.

#IMMUTABILITY
#so it means that string in python are immutable

imstring = "immutable" # so her if we want to change this value of the string we have to
...
imstring = imstring + 'i' # here it will add one char after the existing string , and it will become
                          # a new string
print(imstring)           